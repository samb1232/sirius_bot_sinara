...
from db.db_operations import DbHelper

# Токен вашего бота
API_TOKEN = '8055871698:AAFGUyubwivWs0EyntAhZZngXpxb617nk94'
...
async def process_photo(message: types.Message, state: FSMContext):
    async with state.proxy() as data:
        ...
        photo_file = await photo.download(destination_file='../fns/sirius_bot_sinara/user_photo.jpg')
        with open('../fns/sirius_bot_sinara/user_photo.jpg', 'rb') as f:
            photo_blob = f.read()
